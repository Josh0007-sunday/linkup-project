...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>LINKUP || Register skill</title>
  ...
  <body>
   ...
   <div class="w3-top">
      <div class="w3-bar w3-card w3-darkblue">
        <a href="../register.html" class="w3-padding w3-right" onclick="myFunction()"
      ...
      <div class="row justify-content-center">
        ...
        >
          <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
            <h2 id="heading">Register Skill</h2>
            <p>Fill all form field to go to next step</p>

            <form name="campusbasedform" onsubmit="return validateForm()"  method="post" action="processor/campus.php" id="msform">
              <!-- progressbar -->
              <ul id="progressbar">
                <li class="active" id="account"><strong>Campus</strong></li>
                <li id="personal"><strong>Personal</strong></li>
                <li id="payment"><strong>Skill Registration</strong></li>
              ...
              <fieldset>
                <div class="form-card">
                  ...
                  <input type="number" name="phno" id="phno" placeholder="Contact No." />
              ...
              <fieldset>
                <div class="form-card">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="fs-title">Skill Registration:</h2>
                    </div>
                    <div class="col-5">
